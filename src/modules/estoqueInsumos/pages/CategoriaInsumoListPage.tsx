...
import { useCategoriasInsumo, useDeleteCategoriaInsumo } from '../hooks/useCategoriasInsumo'
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Gerencie as categorias de insumos"
      >
        <button
          onClick={() => navigate('/estoque-insumos/categorias/novo')}
          ...
          <tr key={c.id} className="hover:bg-gray-50 transition-colors">
            ...
            <td className="px-4 py-3">
              <div className="flex items-center gap-2">
                <button
                  onClick={() => navigate(`/estoque-insumos/categorias/${c.id}/editar`)}
